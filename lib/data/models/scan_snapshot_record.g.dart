...
part of 'scan_snapshot_record.dart';
...
extension GetScanSnapshotRecordCollection on Isar {
  IsarCollection<ScanSnapshotRecord> get scanSnapshotRecords =>
      this.collection();
}

const ScanSnapshotRecordSchema = CollectionSchema(
  name: r'ScanSnapshotRecord',
  id: -5760620427191831408,
  properties: {
  ...
  deserialize: _scanSnapshotRecordDeserialize,
  deserializeProp: _scanSnapshotRecordDeserializeProp,
  idName: r'id',
  indexes: {},
  links: {},
  embeddedSchemas: {},
  getId: _scanSnapshotRecordGetId,
  getLinks: _scanSnapshotRecordGetLinks,
  attach: _scanSnapshotRecordAttach,
  version: '3.1.0+1',
);

int _scanSnapshotRecordEstimateSize(
...
void _scanSnapshotRecordSerialize(
  ScanSnapshotRecord object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
ScanSnapshotRecord _scanSnapshotRecordDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = ScanSnapshotRecord();
  object.id = id;
...
P _scanSnapshotRecordDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _scanSnapshotRecordGetId(ScanSnapshotRecord object) {
  return object.id;
}
...
extension ScanSnapshotRecordQueryWhereSort
    on QueryBuilder<ScanSnapshotRecord, ScanSnapshotRecord, QWhere> {
  QueryBuilder<ScanSnapshotRecord, ScanSnapshotRecord, QAfterWhere> anyId() {
...
extension ScanSnapshotRecordQueryObject
    on QueryBuilder<ScanSnapshotRecord, ScanSnapshotRecord, QFilterCondition> {}

extension ScanSnapshotRecordQueryLinks
    on QueryBuilder<ScanSnapshotRecord, ScanSnapshotRecord, QFilterCondition> {}
...
extension ScanSnapshotRecordQueryProperty
    on QueryBuilder<ScanSnapshotRecord, ScanSnapshotRecord, QQueryProperty> {
  QueryBuilder<ScanSnapshotRecord, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
