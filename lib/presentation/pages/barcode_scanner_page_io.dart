    ...
    await Navigator.of(context).push(
      MaterialPageRoute<void>(
        builder: (BuildContext context) {
          return BarcodeScannerSettingsPage(
...
class BarcodeScannerSettingsPage extends StatefulWidget {
  const BarcodeScannerSettingsPage({
    super.key,
  ...
  @override
  State<BarcodeScannerSettingsPage> createState() =>
      _BarcodeScannerSettingsPageState();
}

class _BarcodeScannerSettingsPageState
    extends State<BarcodeScannerSettingsPage> {
